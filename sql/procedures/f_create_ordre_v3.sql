CREATE OR REPLACE PROCEDURE F_CREATE_ORDRE_V3(
...
BEGIN
    ...
    begin
        select
            ...
            crt_code, crt_bta_code, crt_pu, instructions_seccom, REPLACE(instructions_logistique, NULL, ''),
    ...
    begin
        select
            ...
            instructions_seccom, REPLACE(instructions_logistique, NULL, ''), trp_pu, trs_pu, gest_ref
        into
    ...
    begin
        INSERT INTO GEO_ORDRE (
            ...
            CRT_CODE, CRT_BTA_CODE, CRT_PU, TRP_BAC_CODE, FRAIS_PLATEFORME, FLAG_GEO2, VERSION_ORDRE_DATE, VERSION_ORDRE
        ) VALUES (
             ...
             ls_crt_code, ls_crt_bta_code, ld_crt_pu, ls_trp_bac_code, ld_frais_plateforme, 'O', ldate_version, '001'
         );
