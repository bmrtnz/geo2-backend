    ...
    if res = 1 then
        ...
        if res = 1 then
            ...
            Else
                ...
                result := ld_vte_ord_tot - ld_rem_ord_tot + ld_res_ord_tot - ld_frd_ord_tot - ld_ach_ord_tot - ld_trp_ord_tot - ld_trs_ord_tot - ld_crt_ord_tot - ld_fad_ord_tot;
                result := round(result / ld_vte_ord_tot * 100, 2);
            End If;
        else
