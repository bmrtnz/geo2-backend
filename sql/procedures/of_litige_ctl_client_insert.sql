CREATE OR REPLACE PROCEDURE "OF_LITIGE_CTL_CLIENT_INSERT" (
...
BEGIN
    ...
    If gs_soc_code = 'SA' then
        ...
        into ls_ref_client
        from GEO_ORDRE
        where GEO_ORDRE.ORD_REF = gs_ord_ref;

        begin



            select GEO_CLIENT_CTL.DAT_OLDER_LITIGE
            into ld_older_litige
