...
ALTER TABLE GEO_CLIENT ADD PALOX_GRATUIT VARCHAR2(1) DEFAULT 'N';
ALTER TABLE GEO_CLIENT ADD CONSIGNE_PALOX VARCHAR2(1) DEFAULT 'N';
ALTER TABLE GEO_CLIENT ADD RELEVE_FACTURES VARCHAR2(1) DEFAULT 'N';
ALTER TABLE GEO_CLIENT ADD ID_FISCAL VARCHAR2(50) NULL;