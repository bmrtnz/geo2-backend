...
BEGIN
    ...
    SET
        ...
        GTIN_UC_BW = (SELECT aan.GTIN_UC_BW FROM AVI_ART_GESTION aag LEFT JOIN AVI_ART_NORMALISATION aan ON aag.ref_normalisation = aan.ref_normalisation WHERE aag.ART_REF = avi_art_ref),
        ...
        GTIN_COLIS_BW = (SELECT aan.GTIN_COLIS_BW FROM AVI_ART_GESTION aag LEFT JOIN AVI_ART_NORMALISATION aan ON aag.ref_normalisation = aan.ref_normalisation WHERE aag.ART_REF = avi_art_ref),
