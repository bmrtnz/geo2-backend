...
COMMENT ON COLUMN AVI_ART_NORMALISATION.GTIN_UC_BW IS 'GTIN UC BlueWhale';
COMMENT ON COLUMN AVI_ART_NORMALISATION.GTIN_COLIS IS 'GTIN carton';
COMMENT ON COLUMN AVI_ART_NORMALISATION.GTIN_COLIS_BW IS 'GTIN carton BlueWhale';
...
CREATE UNIQUE INDEX UNIQUE_ART_NORMALISATION ON AVI_ART_NORMALISATION
    (ESP_CODE, CAM_CODE, ETC_CODE, ETF_CODE, ETP_CODE, ETV_CODE, GTIN_COLIS, GTIN_COLIS_BW, GTIN_PALETTE, GTIN_UC, GTIN_UC_BW, PDE_CLIART,
