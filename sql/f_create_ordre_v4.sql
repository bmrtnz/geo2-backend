...
BEGIN
    ...
    DECLARE
        li_ret number;
        trp_bta_code GEO_ENTREP.TRP_BTA_CODE%TYPE := ls_trp_bta_code;
    begin
        f_return_forfaits_trp( arg_entrepot,ls_inc_code,ld_trp_dev_pu,trp_bta_code,ls_trp_dev_code,ls_typ_ordre,res,msg,li_ret);
        If li_ret > 0 Then
