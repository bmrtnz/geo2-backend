CREATE OR REPLACE PROCEDURE OF_GENERE_ENVOIS_LITIGE(
        ...
        begin
            ...
            loop
                ...
                if ls_TIE_CODE = 'CDV' /*and  ib_envoi_cdv = FALSE*/  then
                    ...
                    open C2;
                    fetch C2 	INTO is_con_tyt, is_con_tiers, is_con_ref, is_moc_code, is_con_acces1, is_con_fluvar, is_con_prenom, is_con_nom;
