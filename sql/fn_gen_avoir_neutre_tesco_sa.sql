CREATE OR REPLACE PROCEDURE GEO_ADMIN.FN_GEN_AVOIR_NEUTRE_TESCO_SA (
...
BEGIN
	...
	from GEO_ORDLIG L , GEO_AVOIR_BUK_SA ABS
	where L.ORD_REF = ABS.ORD_REF_SA and
           	 ABS.ORD_REF_SA =  ls_ord_ref_sa and
   	 	     ABS.ORD_REF_BUK =  arg_ord_ref_buk;
    ...
    begin
        ...
        from  GEO_ORDLOG LG, GEO_AVOIR_BUK_SA ABS
        where  LG.ORD_REF  = ABS.ORD_REF_SA and
            	 ABS.ORD_REF_SA =  ls_ord_ref_sa and
   	 	      ABS.ORD_REF_BUK =  arg_ord_ref_buk ;
    exception when others then
    ...
    begin
        UPDATE GEO_AVOIR_BUK_SA SET  ORD_REF_SA_N  = ls_ord_ref_sa_n
