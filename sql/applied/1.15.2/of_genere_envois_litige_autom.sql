...
AS
    ...
    is_instructions_logistique varchar2(500);
    is_trs_ville varchar2(50);
    is_crt_bta_code varchar2(50);
    is_ref_cli varchar2(500);
...
BEGIN
    ...
    begin
        ...
        INTO
            ...
            is_inc_desc,
            is_inc_lieu,
            is_instructions_logistique,
            is_trs_ville,
            is_crt_bta_code,
            is_ref_cli,
            is_per_codeass_prenom,
            is_per_codecom_prenom,
            idt_depdatp,
            idt_datlivp,
            id_remsf_tx,
            id_remhf_tx,
