CREATE OR REPLACE PROCEDURE GEO_ADMIN.F_CREE_AVOIR_TOUS_V2 (
...
BEGIN
    ...
    begin
        ...
        select
            ...
            valide, ttr_code,
            lib_dlv, 'A',ls_comm_interne || nordre,li_frais_pu, arg_username
    ...
    begin
        ...
        loop
            FETCH     C_ordlig_lit into
                ...
                ls_list_certifs,ls_cert_origine ;
