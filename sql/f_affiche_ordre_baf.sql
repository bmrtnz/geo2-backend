CREATE OR REPLACE PROCEDURE "F_AFFICHE_ORDRE_BAF" (
...
BEGIN
    ...
    ls_sql := 'SELECT GEO_ORDRE.ORD_REF,GEO_ORDRE.NORDRE, GEO_ORDRE.CAM_CODE,GEO_CLIENT.RAISOC AS CLIENT, GEO_ENTREP.CEN_CODE || ''-'' || GEO_ENTREP.RAISOC AS ENTREP, GEO_TRANSP.RAISOC AS TRANSP, to_char(GEO_ORDRE.LIVDATP,''dd/mm/yy'') as LIVDATPFR, to_char(GEO_ORDRE.LIVDATP,''yy/mm/dd'') AS LIVDATPEN, GEO_ORDRE.REF_CLI ';
