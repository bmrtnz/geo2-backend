...
CREATE TABLE GEO_ADMIN.GEO_MODIF_CORPS (
	...
	VALEUR_ACTUELLE VARCHAR2(500),
	VALEUR_DEMANDEE VARCHAR2(500),
	AFFICHAGE_ACTUEL VARCHAR2(100),
	AFFICHAGE_DEMANDE VARCHAR2(100),
	VALIDATEUR VARCHAR2(35),
	MOD_DATE DATE
);
...
ALTER TABLE GEO_ADMIN.GEO_MODIF_CORPS ADD CONSTRAINT FK_MODIF_CORPS_USER FOREIGN KEY (VALIDATEUR) REFERENCES GEO_ADMIN.GEO_USER(NOM_UTILISATEUR) ON DELETE CASCADE;
