...
begin
    ...
    select ol.propr_code, ol.ord_ref, ol.art_ref, o.tvt_code, o.sco_code, ol.vte_bta_code, ol.ach_bta_code, o.typ_ordre, ol.fou_code, o.cen_ref, ol.orl_lig
    into ls_val, ls_ord_ref, ls_art_ref, ls_tvt_code, ls_sco_code, ls_vte_bta, ls_ach_bta, ls_typ_ordre, ls_fou_code_old, ls_cen_ref, ls_orl_lig
    from geo_ordlig ol
