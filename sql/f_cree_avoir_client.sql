...
BEGIN
    ...
    */
    begin
        ...
        O.valide, O.ttr_code,
        lib_dlv, 'A', ls_comm_interne || O.nordre,li_frais_pu
    ...
    begin
        ...
        fou_code, grp_code, trp_code, valide, lib_dlv, pca_ref, pde_ref, art_ref,propr_code,var_ristourne,remhf_tx,remsf_tx,frais_pu)
        select
        ...
        ORL.fou_code, ORL.grp_code, ORL.trp_code, ORL.valide, ORL.lib_dlv, ORL.pca_ref, ORL.pde_ref, ORL.art_ref,ORL.propr_code,ORL.var_ristourne,ORL.remhf_tx,ORL.remsf_tx,li_frais_pu
