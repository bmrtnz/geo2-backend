ALTER SESSION SET CURRENT_SCHEMA=GEO_ADMIN;
...
BEGIN
    ...
    SET
        ...
        GTIN_UC_BW = (SELECT GTIN_UC_BW FROM AVI_ART_GESTION WHERE ART_REF = avi_art_ref),
        GTIN_COLIS_BW = (SELECT GTIN_COLIS_BW FROM AVI_ART_GESTION WHERE ART_REF = avi_art_ref),
...
END;
alter procedure SYNC_ARTICLE compile;
