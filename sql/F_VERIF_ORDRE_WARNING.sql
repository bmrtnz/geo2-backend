...
BEGIN
    ...
    if ls_trp_code <> 'CLIENT' and ls_trp_code <> 'STATIO' and ld_tottrp = 0 and ls_inc_rd <> 'D' and ls_facture_avoir = 'F' and (ll_nb_ligne_ordre <> ll_nb_ligne_gratuit) and arg_soc_code <> 'BUK' then
