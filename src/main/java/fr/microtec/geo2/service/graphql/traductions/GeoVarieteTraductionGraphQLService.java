...
@GraphQLApi
@Secured("ROLE_USER")
public class GeoVarieteTraductionGraphQLService
        extends GeoAbstractGraphQLService<GeoVarieteTraduction, GeoVarieteTraductionId> {
    ...
    @GraphQLQuery
    public Optional<GeoVarieteTraduction> getVarieteTraduction(
            @GraphQLArgument(name = "id") GeoVarieteTraductionId id,
            @GraphQLEnvironment ResolutionEnvironment env) {
